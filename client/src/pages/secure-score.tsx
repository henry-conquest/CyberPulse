        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-700 mb-4">
              {secureScorePercent < 40 && "Urgent action required. Your Microsoft 365 environment has significant security gaps that need immediate attention."}
              {secureScorePercent >= 40 && secureScorePercent < 70 && "Improvement needed. While your security posture is fair, there are still important security measures that should be implemented."}
              {secureScorePercent >= 70 && "Good security posture. Your Microsoft 365 environment has implemented most recommended security controls."}
            </p>
