...
export default function Reports() {
  ...
  const createReportMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['/api/tenants', selectedTenantId, 'reports'] });
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <p className="text-secondary-500">
            Generate, review, and send cyber risk reports to clients
          </p>
        </div>
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Generate a new cyber risk report for the selected tenant.
                </DialogDescription>
              </DialogHeader>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            {...field} 
                            placeholder="Add initial comments or recommendations..." 
                            rows={5}
                          />
                        </FormControl>
                        <FormDescription>
                          You can add or edit comments later.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <TableBody>
                {reports.map((report: Report) => (
                  <TableRow key={report.id}>
                    ...
                    <TableCell>
                      <span className={
                        report.overallRiskScore > 70 ? "text-danger" : 
                        report.overallRiskScore > 30 ? "text-warning" : 
                        "text-success"
                      }>
