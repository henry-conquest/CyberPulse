...
export default function SecureScoreWidget({
  ...
  return (
    <div className="flex flex-col items-center p-4">
      ...
      <div className="text-sm font-medium text-gray-700 mb-2">{scoreStatus} Security Posture</div>

      <div className="text-sm text-gray-600 mb-2">Score: {currentScore}</div>
      ...
      {hasChanged ? (
        ...
        <div className="mt-2 text-gray-500 text-sm">No previous data available for comparison</div>
      )}
