...
export default function SecurityItem({ title, status, icon, className }: SecurityItemProps) {
  ...
  return (
    <div className={cn('flex items-center justify-between', className)}>
      ...
      <span className={cn('font-semibold text-sm', statusInfo.textClass)}>{statusInfo.text}</span>
    </div>
  );
}
